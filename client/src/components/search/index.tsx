...
// export const Search = ({ widthFull = false }: { widthFull?: boolean }) => {
//   return (
//     <div className="bg-white w-full py-4 justify-between px-4 sm:px-6 md:px-8 flex flex-col md:flex-row items-center gap-4 sm:gap-6 shadow-custom">
//       <div className="flex items-center gap-2 sm:gap-4 w-full">
//         <img src={SearchIcon} alt="search" />
//         <input
//           type="text"
//           placeholder="Job title or keyword"
//           className="outline-none border-b border-neutrals20 p-2 w-full"
//         />
//       </div>
//       <div className="flex items-center gap-2 sm:gap-4 w-full">
//         <img src={Location} alt="location" />
